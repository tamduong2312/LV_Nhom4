...
public class ToaThuocDao {
    ...
    public int taoToaMoi(int maPhieuKham, String ghiChu) {
        ...
        String sql = "INSERT INTO toa_thuoc(ma_phieu_kham, ghi_chu, ngay_tao, tong_tien) VALUES(?, ?, NOW(), NULL)";
    ...
    // --- HÀM 2: TÌM KIẾM THEO TỪ KHÓA (Tên BN hoặc Mã Toa) ---
    ...
    // --- HÀM 3: TÌM KIẾM THEO BỘ LỌC NGÀY ---
    ...
    // --- HÀM PHỤ: Map dữ liệu (Để code trên ngắn gọn) ---
