...
public class NhanVienDao {
    ...
    public List<NhanVien> getAllNhanVien() {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
            ...
            while (rs.next()) {
                ...
                nv.setSDT(rs.getLong("so_dien_thoai"));
                ...
                nv.setCalam(rs.getTime("gio_lam_viec"));
    ...
    public List<NhanVien> getVaiTro() {
        List<NhanVien> list = new ArrayList<>();
        String query = "SELECT vai_tro FROM nhan_vien";
    ...
    public int themNhanVien(NhanVien nv) {
        ...
        String query = "INSERT INTO nhan_vien (" +
                ...
                " ma_nguoi_dung,gio_lam_viec, vai_tro) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public int suaNV(NhanVien nv, int id1) {
        ...
        String query = "UPDATE nhan_vien SET ho_ten = ?, gioi_tinh = ?, ngay_sinh = ?, cccd = ?, dia_chi = ?, so_dien_thoai = ?, " +
                       "email = ?, bang_cap = ?, chuc_vu = ?, chuyen_khoa = ?, ngay_vao_lam = ?,  " +
                       "ma_nguoi_dung = ?, vai_tro = ? , gio_lam_viec = ? WHERE ma_nhan_vien = ?";
