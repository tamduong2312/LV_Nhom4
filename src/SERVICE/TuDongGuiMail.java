...
public class TuDongGuiMail {
    ...
    private static final String DB_PASS = ""; // Điền pass của bạn
    ...
    public static void quetVaGuiMail() {
        ...
        try {
            ...
            // 1. Lấy danh sách bệnh nhân tái khám NGÀY MAI (hoặc sắp tới)
            // Logic: Ngày tái khám = Ngày hiện tại + 1 ngày
            // Và trạng thái chưa đến, và chưa gửi mail
            ...
            while (rs.next()) {
                ...
                if (email != null && !email.isEmpty()) {
                    ...
                    // 3. Nếu gửi thành công -> Update database để không gửi lại
                    if (guiThanhCong) {
