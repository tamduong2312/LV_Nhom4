...
public class CTHoaDon {
    ...
    private String noiDung; // Thay cho maDichVu, maThuoc
    private String loaiMuc; // "DICH_VU" hoặc "THUOC"
    private int idGoc;      // Lưu ID gốc để tham chiếu
    private int soLuong;
    private double donGia;  // Thêm đơn giá
