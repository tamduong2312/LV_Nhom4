...
public class PnlNhapKqChuanDoanHinhAnh extends JPanel {
    ...
    public PnlNhapKqChuanDoanHinhAnh(int idChiTietChiDinh, String tenBN, String tenDV,int iddangky) {
    ...
    private void themDongChonAnh(String duongDan) {
        ...
        // Nhãn hiển thị số thứ tự (sẽ được cập nhật lại ở bước sau)
    ...
    private void saveAction() {
        ...
        if (kq) {
            ...
            pkbus.updateTrangThaiPhieuKhamTheoMaDangKy(   Session.maDangKyHienTai);
            
            
            
            PhieuKhamBus bus2 = new PhieuKhamBus();
            bus2.updateTrangThaiDAKHAMTrongChiDinhCLS(this.idChiTietChiDinh);
            
    
        	DangKyKhamBenhBus bus1 = new DangKyKhamBenhBus();
       
    		bus1.capNhatDaKhamById(this.iddangky);
        }
    }
    ...
    private void checkAndLoadData() {
    	JOptionPane.showMessageDialog(null,  this.idChiTietChiDinh);
