...
public class FrmNhapChiSoSinhTon1 extends JPanel {
	...
	public FrmNhapChiSoSinhTon1(int idDangKy, int mabn, String tendv) {
	...
	public void loadData() {
	    ...
	    ChiSoTongQuatBus bus = new ChiSoTongQuatBus();
	    List<ChiSoTongQuat> currentData = bus.getallChiSo(Session.maphieukham);
