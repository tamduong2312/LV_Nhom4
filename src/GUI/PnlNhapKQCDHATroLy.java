...
public class PnlNhapKQCDHATroLy extends JPanel {
    ...
    public PnlNhapKQCDHATroLy(int idChiTietChiDinh, String tenBN, String tenDV) {
        this.tenBenhNhan = (tenBN != null) ? tenBN : "";
        this.tenDichVu = (tenDV != null) ? tenDV : "";

        XetNghiemBus bus = new XetNghiemBus();
        this.idChiTietChiDinh = bus.layIdChiTietByMaPhieuKham(Session.maDangKyHienTai);
    ...
    private void saveAction() {
        ...
        boolean kq = isUpdateMode ? 
            chiDinhBus.capNhatKetQuaDaCo(idChiTietChiDinh, txtMoTa.getText(), txtKetLuan.getText(), 
                                         txtDeNghi.getText(), Session.maNhanVien, sb.toString(), null) :
            chiDinhBus.luuKetQuaCDHAMoi(idChiTietChiDinh, txtMoTa.getText(), txtKetLuan.getText(), 
                                         txtDeNghi.getText(), Session.maNhanVien, sb.toString(), null);
        ...
        if (kq) {
            ...
            bus2.updateTrangThaiThucHienCLSTrongCTChiDinh(idChiTietChiDinh);
