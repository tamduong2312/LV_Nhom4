...
public class FrmLoadTKBBS extends JFrame {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    FrmLoadTKBBS frame = new FrmLoadTKBBS(1,tenbs); 
    ...
    public FrmLoadTKBBS(int maNV, String tenbs) {
    	this.manv = maNV;
    	this.tenbs = tenbs;
    ...
    private void initUI() {
        ...
        JLabel lblTitle = new JLabel("LỊCH LÀM VIỆC CỦA BÁC SĨ: " + this.tenbs );
        ...
        pnlCenter.setBorder(new EmptyBorder(20, 20, 10, 20)); 
    ...
    private void loadLichLamViec() {
        List<BangPhanCongCaLam> listCaLam = bpbus.getCaLamCuaNhanVien(this.manv);
