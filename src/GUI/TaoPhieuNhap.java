...
public class TaoPhieuNhap extends JDialog {
    ...
    private void initUI() {
        ...
        styleButton(btnThemNCC, new Color(23, 162, 184), Color.WHITE);
        btnThemNCC.setBounds(315, 30, 20, 25);
        pnlHeader.add(btnThemNCC);
    ...
    private void initEvents() {
        ...
        btnThemNCC.addActionListener(e -> {
            String name = JOptionPane.showInputDialog(this, "Tên NCC mới:");
            if (name != null && !name.isEmpty()) JOptionPane.showMessageDialog(this, "Demo: Đã thêm " + name);
        });
