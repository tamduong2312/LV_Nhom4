...
public class FrmDanhSachKhamBenhCuaBSTQ extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                FrmDanhSachKhamBenhCuaBSTQ frame = new FrmDanhSachKhamBenhCuaBSTQ();
    ...
    public FrmDanhSachKhamBenhCuaBSTQ() {
        setTitle("Danh Sách Chờ Khám - Bác Sĩ Tổng Quát");
        ...
        btnKham.addActionListener(e -> {
            ...
            FrmKhamBenhTQDanhChoBSTQ q = new FrmKhamBenhTQDanhChoBSTQ(tenbn);
            q.setVisible(true);
            dispose();
        });
    ...
    private void loadTableDangKyHomNay() {
        ...
        List<DangKyKhamBenh> listDK = dkBus.getAllTodayBSTQ(Session.machuyenkhoa);
