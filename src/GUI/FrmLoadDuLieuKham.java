...
public class FrmLoadDuLieuKham extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                FrmLoadDuLieuKham frame = new FrmLoadDuLieuKham(mapk, mabn,mack);
    ...
    public FrmLoadDuLieuKham(int mapk , String mabn, int mack) {
        setTitle("Giao diện lịch sử khám bệnh");
        ...
        JScrollPane mainScroll = new JScrollPane(contentPane);
        ...
        btnLichSu.addActionListener(e -> {
            FrmLoadLichSuKham q = new FrmLoadLichSuKham(Integer.parseInt(this.mabn));
            q.setVisible(true);
            dispose();
        });
        ...
        btnXemChiSo.addActionListener(e -> {
            ...
            FrmXemChiSoTongQuatCuaBSTQ content = new FrmXemChiSoTongQuatCuaBSTQ(mapk,Session.mabenhnhan);
        ...
        String infoHtml = "<html><span style='font-size:14px; padding-left:10px;'><b>Bệnh nhân: </b> " +  this.mabn.toUpperCase();
        ...
        switch (maCK) {
            case 3: 
                pnlKhamBenh = new FrmKhamLamSangNhiKhoa(mapk, this.mabn,"check");
                tabbedPane.addTab("Khám Nhi", null, new PnlKhamNhiKhoa(mapk,"check"), null);
                break;
            case 1:
                pnlKhamBenh = new FrmKhamLamSang1(mapk, tenbn,"check");
                break;
            case 4: 
                pnlKhamBenh = new FrmKhamLamSangNhiKhoa(mapk, this.mabn,"check");
                tabbedPane.addTab("Tai - Mũi - Họng", null, new PnlKhamTaiMuiHong(mapk,"check"), null);
                break;
            case 11: 
                pnlKhamBenh = new FrmKhamLamSangNhiKhoa(mapk, this.mabn,"check");
                tabbedPane.addTab("Tim Mạch", null, new PnlKhamTimMach(mapk,"check"), null);
                break;
            case 5: 
                pnlKhamBenh = new FrmKhamLamSangNhiKhoa(mapk, this.mabn,"check");
                tabbedPane.addTab("Răng - Hàm - Mặt", null, new PnlKhamRangHamMat(mapk,"check"), null);
                break;
            default:
                break;
        }

        tabbedPane.addTab("Khám bệnh", null, pnlKhamBenh, null);
        tabbedPane.addTab("Chỉ Định dịch vụ", null, new PnlChiDinhDichVu(mapk,"check"), null);
        tabbedPane.addTab("Kê toa thuốc", null, new ToaThuoc1(mapk,"check"), null);
