...
public class FrmLoadDuLieuKham extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                FrmLoadDuLieuKham frame = new FrmLoadDuLieuKham(mapk,mabn);
    ...
    public FrmLoadDuLieuKham(int mapk , String mabn) {
        ...
        btnXemChiSo.addActionListener(e -> {
            ...
            FrmXemChiSoTongQuatCuaBSTQ content = new FrmXemChiSoTongQuatCuaBSTQ(mapk);
        ...
        // =================================================================
        // LOGIC CHỌN FORM KHÁM THEO MÃ CHUYÊN KHOA
        // =================================================================
        JPanel pnlKhamBenh = null;

        
        // Lấy mã chuyên khoa từ Session (Hoặc có thể lấy từ tham số nếu cần)
        int maCK = Session.machuyenkhoa; 
        
        switch (maCK) {
            case 3: // Nhi khoa
                // Hiển thị form riêng bạn tự thêm
            	pnlKhamBenh = new  FrmKhamLamSangNhiKhoa(mapk);
                tabbedPane.addTab("Khám Nhi", null, new PnlKhamNhiKhoa(mapk), null);
                break;
                
            case 1: // Nội tổng quát
                pnlKhamBenh = new FrmKhamLamSang1(mapk,"");
                break;
            case 4: // Tai Mũi Họng (Ví dụ)
            	
                tabbedPane.addTab("Tai - Mũi - Họng", null, new PnlTaiMuiHong(mapk), null);
                break;
            case 5: 
            	
            	pnlKhamBenh = new  FrmKhamLamSangNhiKhoa(mapk);
                tabbedPane.addTab("Răng - Hàm - Mặt", null, new PnlKhamRangHamMat(mapk), null);
                break;// Răng Hàm Mặt (Ví dụ)
            case 7: // Xét nghiệm
            default:
                // Các khoa khác dùng form Khám Lâm Sàng chuẩn
         
                break;
        }

        // Add Tab đã được chọn vào
        tabbedPane.addTab("Khám bệnh", null, pnlKhamBenh, null);
        // =================================================================

        tabbedPane.addTab("Chỉ Định dịch vụ", null, new PnlChiDinhDichVu(mapk), null);
        JPanel panelThuoc = new JPanel(); panelThuoc.setBackground(Color.WHITE);
        tabbedPane.addTab("Kê toa thuốc", null, new ToaThuoc1(mapk), null);
