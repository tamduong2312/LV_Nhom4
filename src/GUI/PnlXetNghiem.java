...
public class PnlXetNghiem extends JFrame {
    ...
    public PnlXetNghiem(int idChiTietChiDinh, String tenbn) {
        this.idChiTiet = idChiTietChiDinh;
        this.tenbn = tenbn;
        XetNghiemBus busXN = new XetNghiemBus();
        mactchidinh = busXN.layIdChiTietByMaPhieuKham(idChiTietChiDinh);
    ...
    private void save() {
        ...
        try {
            ...
            kq.setMaBSketluan(Session.maNhanVien);
            ...
            if (bus.BSupdate(kq)) {
                ...
                bus2.updateTrangThaiDAKHAMTrongChiDinhCLS(   this.idChiTiet);
