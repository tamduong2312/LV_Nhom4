...
public class FrmKhamBenhCKDanhChoBSCK extends JFrame {
    ...
    public FrmKhamBenhCKDanhChoBSCK(String tenbn) {
        ...
        contentPane.setPreferredSize(new Dimension(950, 1200));
        ...
        tabbedPane.addTab("Khám Tổng Quát", null, new FrmKhamLamSangNhiKhoa(Session.maphieukham, this.tenbn,""), "Thông tin khám sơ bộ");
