    ...
    public FrmLogin() {
        ...
        ActionListener loginAction = e -> {
            ...
            if (login != null) {
                ...
                switch (roleUpper) {
                    case "BAC_SI_TONG_QUAT":

                         new FrmLamViecBacSi().setVisible(true);
                        break;
                    case "BAC_SI_CHUYEN_KHOA":
                        new FrmLamViecBacSi().setVisible(true);
                        break;
                        
                    case "BAC_SI_CHAN_DOAN_HINH_ANH":
                        new FrmLamViecBacSi().setVisible(true);
                        break;
                    ...
                    case "KY_THUAT_VIEN_XET_NGHIEM":
                        new FrmLamViecBacSi().setVisible(true);
                        break;
                    case "LE_TAN": new FrmLeTan().setVisible(true); break;
                    case "TRO_LY_BAC_SI_TONG_QUAT": new FrmTroLy().setVisible(true); break;
                    case "TRO_LY_BAC_SI_CHUYEN_KHOA": new FrmTroLy().setVisible(true); break;
                    case "THU_NGAN": new FrmDuocSiThuNgan().setVisible(true); break;
                    case "DUOC_SI": new FrmDuocSiThuNgan().setVisible(true); break;
                    case "NHAN_VIEN_KHO": new FrmQLKhoThuoc("").setVisible(true); break;
                    case "QUAN_TRI_VIEN": new FrmQuanLy().setVisible(true); break;
               
                    default: JOptionPane.showMessageDialog(null, "Không có giao diện cho vai trò: " + Session.role);
                }
                dispose();
            } else {
